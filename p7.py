...
category_keywords={ "sport":["باخت","برد","والیبال","بسکتبال","گل","فوتبال","ورزش","تور","خطا","داور","فدراسیون","مصدوم","سرویس","مربی","کاپیتان"],
                    ...
                    "maths":["ریاضی","فرمول","کسر","انتگرال","مشتق","توان","ضرب","جمع","تفریق","تقسیم","مجهول","پرانتز","جذز"],
                    "computer":["کامپیوتر","رایانه","کد","شبه کد","برنامه نویس","نرم افزار","سخت افزار","لپ تاپ","مانیتور","پرینتر"],
                    "movie":["فیلم","کارگردان","بازیگر","سینما","نمایش","فیلمنامه","نویسنده","تلویزیون","تهیه کننده","نقش","درام","کمدی","طنز","تراژدی","سریال"],
                    "war":["جنگ","سرباز","دشمن","فرمانده","اسلحه","تانک","شهید","ایران","عراق","آتش بس","سنگر","اسیر","بی سیم","شکنجه"],
                    "art":["هنر","نقاشی","طرح","خطاطی","نقاش","شعر","شاعر","نمایشگاه","رنگ","قلم","هنرمند","گالری","تابلو","طراح"],
                    "education":["تحصیل","دانشگاه","مدرسه","معلم","استاد","کتاب","فارغ التحصیل","رشته","دانشجو","مقاله","پایان نامه","ترم","کنکور","درس","دانشکده"]}
...
with open("in.txt", "r", encoding="utf-8") as f:
    ...
    for line in file_list:
        ...
        filtered_word_list = stemmed_new_words

        lemmatized_new_words = []
        lemmatizer=Lemmatizer()
        for word in filtered_word_list:
            b=lemmatizer.lemmatize(word)
            lemmatized_new_words.append(b)
            filtered_word_list=lemmatized_new_words
        ...
        o.write('{0} : {1}'.format(subject_result_dict, score))
        o.write('\n')
